...
describe("stable facade and line receipts", () => {
  ...
  test("pinned split suite/module line receipts", () => {
    ...
    const receipts: Array<[string, number]> = [
      ["core/services/pages/pageRendererV2.tsx", 976],
      ["core/services/pages/pageRendererReplicaIdentity.ts", 330],
      ["core/services/pages/pageRendererTimelineGeometry.ts", 63],
      ["core/services/pages/pageSectionRendererV2.tsx", 670],
      ["core/services/pages/pageLayoutBlockRenderer.tsx", 365],
      ["core/services/pages/pageStaticBlockRenderers.tsx", 926],
      ["core/services/pages/pageCompositionEffects.tsx", 420],
      ["core/services/pages/pageDocumentRenderState.ts", 168],
      ["core/services/pages/pageResponsiveCss.ts", 999],
      ...
      ["tests/vitest/pages/page-renderer-replica-identity.test.ts", 241],
      ...
      ["tests/vitest/pages/page-renderer-v2-effects.test.tsx", 721],

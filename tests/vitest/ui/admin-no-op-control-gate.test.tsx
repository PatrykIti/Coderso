...
test("Settings report no-op controls are disabled or explicitly unavailable", () => {
  ...
  const expectations: ControlExpectation[] = [
    ...
    {
      area: "Settings",
      controlId: "settings-sessions-tab-general",
      expected: "disabled",
      reasonPattern: /Only Active Sessions.*TASK-359-07/,
      report: "REPORT_ADMIN_SETTINGS.md",
    },
    {
      area: "Settings",
      controlId: "settings-sessions-tab-audit",
      expected: "disabled",
      reasonPattern: /Only Active Sessions.*TASK-359-07/,
      report: "REPORT_ADMIN_SETTINGS.md",
    },
    {
      area: "Settings",
      controlId: "settings-sessions-tab-two-factor",
      expected: "disabled",
      reasonPattern: /Only Active Sessions.*TASK-359-07/,
      report: "REPORT_ADMIN_SETTINGS.md",
    },
    ...
    {
      area: "Settings",
      controlId: "settings-login-alerts-tab-general",
      expected: "disabled",
      reasonPattern: /Only Login Alerts.*TASK-359-07/,
      report: "REPORT_ADMIN_SETTINGS.md",
    },
    {
      area: "Settings",
      controlId: "settings-login-alerts-tab-active-sessions",
      expected: "disabled",
      reasonPattern: /Only Login Alerts.*TASK-359-07/,
      report: "REPORT_ADMIN_SETTINGS.md",
    },
    {
      area: "Settings",
      controlId: "settings-login-alerts-tab-audit-log",
      expected: "disabled",
      reasonPattern: /Only Login Alerts.*TASK-359-07/,
      report: "REPORT_ADMIN_SETTINGS.md",
    },
    {
      area: "Settings",
      controlId: "settings-login-alerts-tab-two-factor",
      expected: "disabled",
      reasonPattern: /Only Login Alerts.*TASK-359-07/,
      report: "REPORT_ADMIN_SETTINGS.md",
    },

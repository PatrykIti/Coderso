...
test("Users report no-op controls are disabled with explicit reasons", () => {
  ...
  expectNoOpControlExpectations(root, [
    ...
    },
    {
      ...
      expected: "disabled",
      reasonPattern: /Notification preferences.*TASK-355-04/,
      report: "REPORT_ADMIN_USERS.md",
    },
    {
      area: "Users",
...
test("Audit Logs report no-op controls are disabled with explicit reasons", () => {
  ...
  expectNoOpControlExpectations(root, [
    ...
    },
    {
      ...
      expected: "disabled",
      reasonPattern: /Single-entry export.*TASK-357-02/,
      report: "REPORT_ADMIN_AUDIT_LOGS.md",
    },
    {
      area: "Audit Logs",
    ...
    },
    {
      ...
      expected: "disabled",
      reasonPattern: /Share Log.*TASK-357-02/,
      report: "REPORT_ADMIN_AUDIT_LOGS.md",
    },
    {
      area: "Audit Logs",
      ...
      expected: "disabled",
      reasonPattern: /Report.*TASK-357-02/,
      report: "REPORT_ADMIN_AUDIT_LOGS.md",
    },
    {
      area: "Audit Logs",

...
export const pageEditorBlockLabels: Record<PageBlockType, string> = {
  ...
  columns: "Columns",
  group: "Group",
  // TASK-522-01-L01: custom-SVG palette label mirrors blockOptionCopy.customSvg.
  customSvg: "Custom SVG",
  // ── TASK-534/580 ── switcher + scrollHint + legacy-widget palette labels (mirror blockOptionCopy).
  switcher: "Switcher",

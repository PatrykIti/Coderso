...
export const activeSurfaceState = {
...
export const previewDialogState = {
  latest: null as null | {
    open: boolean;
    title: string;
    canPreview: boolean;
...
export const mediaLibraryState = {
  items: [
...
export const collectionClientsState = (() => {
...
export const pageEditorFlowMockFactories = {
  sonner: {
    toast: {
...
export const pageEditorBlockLabels: Record<PageBlockType, string> = {
  ...
  // ── TASK-580-03-L01 ── legacy-widget is migration-only (never editor-
  // insertable, so the palette never surfaces it); the exhaustive
  // Record<PageBlockType, string> still needs a member for root tsc.

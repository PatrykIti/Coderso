...
const EXPECTED_EXECUTOR_MODULE_PATHS = Object.freeze([
  ...
  "_docs/_workflows/task-540-smoke/executor/finalization.mjs",
  ...
  "_docs/_workflows/task-540-smoke/executor/self-test/browser-widget-absence-scope.mjs",
  ...
  "_docs/_workflows/task-540-smoke/executor/self-test/storage-manifest-identity.mjs",
...
function readExecutorModuleGraph(): ReadonlyMap<string, string> {
  ...
  expect(EXPECTED_EXECUTOR_MODULE_PATHS).toHaveLength(148);

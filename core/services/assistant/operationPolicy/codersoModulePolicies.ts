...
export const codersoSearchPolicy: AssistantResourcePolicy = modulePolicy({
  kind: "coderso-search",
  label: "Coderso Search",
  aliases: ["coderso search", "search module", "listing search", "wyszukiwarka coderso"],
  route: "/admin/coderso/search",
...
export const solutionKitPolicy: AssistantResourcePolicy = modulePolicy({
  ...
  route: "/admin/coderso/solution-kits",
...
export const codersoModulePolicies = {
  post: postPolicy,
  filters: filtersPolicy,
  "coderso-search": codersoSearchPolicy,

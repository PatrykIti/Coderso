...
const answerFields = (
  fields: readonly AssistantSiteBuilderIntakeAnswerFieldDefinition[]
): readonly AssistantSiteBuilderIntakeAnswerFieldDefinition[] =>
  ...
  [
      ...
      answerFields: answerFields([
        {
          key: "siteName",
          label: "Site name",
          description: "Public site or project name.",
          control: "text",
          required: false,
          requiredGroupId: "profileIdentity",
          maxLength: 120,
        },
        {
          key: "entityName",
          label: "Business or entity name",
          description: "Company, organization, creator, venue, or project owner.",
          control: "text",
          required: false,
          requiredGroupId: "profileIdentity",
          maxLength: 120,
        ...
        },
        {
          key: "vertical",
          label: "Vertical",
          description: "General industry, field, or content area.",
          control: "text",
          required: false,
          maxLength: 120,
        },
        {
          key: "audience",
          label: "Audience",
          description: "Primary visitor or customer group.",
          control: "textarea",
          required: false,
          maxLength: 240,
        },
        {
          key: "locale",
          label: "Language",
          description: "Language or locale for generated structure and copy.",
          control: "text",
          required: true,
          maxLength: 16,
        },
        {
          key: "region",
          label: "Region",
          description: "Country, city, service area, or market context.",
          control: "text",
          required: false,
          maxLength: 80,
        },
        {
          key: "summary",
          label: "Summary",
          description: "Plain-language site description.",
          control: "textarea",
          required: false,
          requiredGroupId: "profileIdentity",
          maxLength: 500,
        },
        {
          key: "offerSummary",
          label: "Offer summary",
          description: "What the site should sell, explain, book, or promote.",
          control: "textarea",
          required: false,
          maxLength: 500,
        },
      ...
      answerFields: answerFields([
        {
          key: "goals",
          label: "Goals",
          description: "Short list of outcomes the site should support.",
          control: "text_list",
          required: true,
          maxItems: 8,
          maxLength: 120,
        },
        {
          key: "primaryGoal",
          label: "Primary goal",
          description: "The most important outcome for the site.",
          control: "text",
          required: false,
          maxLength: 160,
        },
        {
          key: "notes",
          label: "Notes",
          description: "Additional goal context.",
          control: "textarea",
          required: false,
          maxLength: 360,
        },
      ...
      answerFields: answerFields([
        {
          key: "pageRoles",
          label: "Page roles",
          description: "Generic pages or collections to include in the site.",
      ...
      answerFields: answerFields([
        {
          key: "menuPreset",
          label: "Menu preset",
          description: "Navigation structure and emphasis.",
          control: "select",
          required: true,
          optionRegistryId: "menuPresets",
        },
        {
          ...
          description: "Optional label for the main contact, inquiry, booking, or purchase action.",
          control: "text",
          required: false,
          maxLength: 80,
        },
        {
          key: "primaryActionPageRole",
          label: "Primary action target",
          description: "Generic page role used as the primary action target.",
          control: "select",
          required: false,
          optionRegistryId: "pageRoles",
        },
      ...
      answerFields: answerFields([
        {
          key: "heroPreset",
          label: "Hero preset",
          description: "Opening section structure.",
          control: "select",
          required: true,
          optionRegistryId: "heroPresets",
        },
        {
          key: "headline",
          label: "Headline",
          description: "Optional main opening headline.",
          control: "text",
          required: false,
          maxLength: 160,
        },
        {
          key: "subheadline",
          label: "Subheadline",
          description: "Optional supporting opening copy.",
          control: "textarea",
          required: false,
          maxLength: 280,
        },
        {
          key: "primaryCallToAction",
          label: "Primary call to action",
          description: "Optional main action text.",
          control: "text",
          required: false,
          maxLength: 80,
        },
      ...
      answerFields: answerFields([
        {
          key: "sectionRoles",
          label: "Section roles",
          description: "Reusable homepage sections to include.",
          control: "multi_select",
          required: true,
          maxItems: 12,
          optionRegistryId: "sectionRoles",
    ...
    },
    {
      ...
      answerFields: answerFields([
        {
          key: "pageRoles",
          label: "Additional page roles",
          description: "Optional extra pages or collections.",
          control: "multi_select",
          required: false,
          maxItems: 14,
          optionRegistryId: "pageRoles",
        ...
        },
        {
          key: "notes",
          label: "Notes",
          description: "Additional page or subpage context.",
          control: "textarea",
          required: false,
          maxLength: 360,
        },
      ...
      answerFields: answerFields([
        {
          key: "mediaPolicy",
          label: "Media policy",
          description: "Allowed source of images and other media.",
          control: "select",
          required: true,
          optionRegistryId: "mediaPolicies",
        },
        {
          key: "notes",
          label: "Notes",
          description: "Optional media preferences or constraints.",
          control: "textarea",
          required: false,
          maxLength: 360,
        },
      ...
      answerFields: answerFields([
        {
          ...
          description: "Structured content families to prepare for the site.",
          control: "multi_select",
          required: false,
          maxItems: 10,
          optionRegistryId: "contentEngines",
        },
        {
          key: "notes",
          label: "Notes",
          description: "Optional content-engine context.",
          control: "textarea",
          required: false,
          maxLength: 360,
        },
    ...
    },
    {
      ...
      answerFields: answerFields([
        ...
        },
        {
          key: "designBrief",
          label: "Design brief",
          description: "Controlled visual direction in plain language.",
          control: "textarea",
          required: false,
          maxLength: 700,
        },
        {
          key: "tone",
          label: "Tone",
          description: "Visual or writing tone.",
          control: "text",
          required: false,
          maxLength: 160,
        },
        {
          key: "colorNotes",
          label: "Color notes",
          description: "Bounded color direction before token mapping.",
          control: "textarea",
          required: false,
          maxLength: 240,
        },
        {
          key: "layoutNotes",
          label: "Layout notes",
          description: "Bounded layout direction before preset mapping.",
          control: "textarea",
          required: false,
          maxLength: 360,
        },
      ...
      answerFields: answerFields([
        {
          ...
          description: "Plain-language observations from safe references.",
          control: "textarea",
          required: false,
          maxLength: 700,
        },
        {
          ...
          description: "Short names for reviewed references.",
          control: "text_list",
          required: false,
          maxItems: 8,
          maxLength: 120,
        },
        {
          key: "referenceIds",
          label: "Reference ids",
          description: "Stable ids for already accepted reference records.",
          control: "text_list",
          required: false,
          maxItems: 8,
          maxLength: 80,
    ...
    },
    {
      ...
      answerFields: answerFields([
        ...
        },
        {
          key: "confirmed",
          label: "Confirmed",
          description: "Explicit confirmation required before executable planning.",
          control: "checkbox",
          required: true,
        },
        {

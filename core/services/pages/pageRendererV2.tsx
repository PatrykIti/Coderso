    ...
    case "customSvg": {
      ...
      return (
        ...
        >
          ...
          {renderSafeSvgNode(tree, "svg-root", Boolean(props.drawIn), true, context.replicaIdentity)}
        </span>
      );
    }
...
const renderPageBlockWithFrame = (block: PageBlockV2, context: PageBlockRenderContext) => {
  ...
  const wrapperLayerWidth =
    wrapperLayerId !== undefined &&
    (block.style?.width === "full" || block.style?.width === "auto")
      ? block.style.width
      : undefined;

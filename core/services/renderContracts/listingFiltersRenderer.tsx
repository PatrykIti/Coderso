...
const resolveListingFiltersCopy = (
  ...
  autoApplyLabel: resolveText(copy?.autoApplyLabel, "Updates automatically when values change."),
  loadingLabel: resolveText(copy?.loadingLabel, "Updating linked results..."),
  errorLabel: resolveText(copy?.errorLabel, "Could not refresh linked results. Try again."),
  ...
  optionSearchTemplate: resolveText(copy?.optionSearchTemplate, "Search {facet} options"),
        ...
        <div className="space-y-2 rounded-md border border-[var(--color-border)]/70 bg-[var(--color-bg)]/30 p-3">
          <div className="flex items-center justify-between gap-3">
            <p className="text-sm font-medium">
              {activeItems.length}{" "}
              {activeItems.length === 1 ? copy.activeFilterSingular : copy.activeFilterPlural}
            </p>
            <button
              type="button"

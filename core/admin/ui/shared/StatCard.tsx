...
/**
 * TASK-479-06-L02: dashboard metric card ported from the prototype
 * (`patterns/StatCard.tsx`). PascalCase host file — import as
 * `@/ui/shared/StatCard`. The base `Card` carries `gap-6 py-6`; `gap-0 p-5`
 * neutralises that rhythm so the metric body matches the prototype padding.
 */

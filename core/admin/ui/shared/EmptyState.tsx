...
/**
 * TASK-479-06-L02: empty/zero-state panel ported from the prototype
 * (`patterns/EmptyState.tsx`). Dashed, dotted card with an optional icon tile,
 * title, description, and a single action slot.
 */

...
export function AuthoringFloatingToolbar({
  ...
  return (
    <div className="pointer-events-auto flex max-w-[calc(100vw_-_2rem)] flex-col items-center gap-2">
      {subpanel ? (
        <div
          className="max-h-[min(520px,calc(100dvh_-_12rem))] w-[min(720px,calc(100vw_-_2rem))] overflow-auto rounded-xl border border-zinc-800 bg-background p-4 text-foreground shadow-2xl"
      ...
      <div
        className="flex max-w-full items-center gap-2 overflow-x-auto rounded-xl border bg-zinc-950 px-2 py-2 text-white shadow-2xl"

...
export const POST_BLOCK_CATALOG: PostBlockCatalogItem[] = [
  ...
  },
  {
    type: "video",
    label: "Video",
    description: "Video from the media library or a safe media URL.",
    category: "media",
    keywords: ["video", "media", "movie", "mp4"],
  },
  {
    type: "gallery",
    label: "Gallery",
    description: "Bounded image gallery with column controls.",
    category: "media",
  ...
  },
  {
    type: "audio",
    label: "Audio",
    description: "Audio from the media library or a safe media URL.",
    category: "media",
    keywords: ["audio", "podcast", "sound", "media"],
  },
  {
    type: "file",
    label: "File",
    description: "Download link for a media library file.",
    category: "media",

 ...
 */
export const ToggleSwitch = ({ label, value, onChange, disabled = false }: ToggleSwitchProps) => (
  <div className="flex items-center justify-between gap-3 py-1" data-page-editor-control="toggle">
    ...
    <button
      ...
      className={`relative h-5 w-9 shrink-0 rounded-full transition-colors disabled:cursor-not-allowed disabled:opacity-50 ${editorControlFocusClass} ${

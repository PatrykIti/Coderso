...
export const logoCloudDefaults: LogoCloudData = {
  ...
  logos: [
    { id: "logo-1", name: "Acme" },
    { id: "logo-2", name: "North Labs" },
    { id: "logo-3", name: "BlueRiver" },
    { id: "logo-4", name: "Orbit" },
    { id: "logo-5", name: "Pixel Forge" },
    { id: "logo-6", name: "Stonegrid" },
  ],
  style: {
    logoHeight: "md",
    grayscale: true,
...
export const logoCloudEditorContract: WidgetEditorContract = {
  ...
  sections: [
    ...
    },
    {
      ...
      title: "Section CTA",
      role: "content",
      writablePaths: ["cta.enabled", "cta.label", "cta.href", "cta.target"],
    },
    {
      mode: "visual",
    ...
    },
    {
      ...
      role: "diagnostics",
      writablePaths: [],
      readOnlyPaths: ["variant", "logos.count", "style.logoHeight", "style.gap"],
    },
    {
      mode: "advanced",
      ...
      role: "diagnostics",
      writablePaths: [],
      readOnlyPaths: ["header", "logos", "cta"],
    },
    {
      mode: "advanced",

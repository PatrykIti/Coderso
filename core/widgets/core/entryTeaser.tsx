...
export const entryTeaserEditorContract: WidgetEditorContract = {
  ...
  sections: [
    ...
    },
    {
      ...
      role: "content",
      writablePaths: ["section.title", "section.headingLevel", "title.headingLevel"],
    },
    {
      mode: "visual",
    ...
    {
      mode: "visual",
      id: "entry-teaser.visual.teaser-content-fields",
    ...
    {
      mode: "visual",
      id: "entry-teaser.visual.layout-media",
      title: "Layout and media",
      role: "visual",
      writablePaths: ["media.mode", "media.aspect", "media.height", "media.fit", "layout.maxWidth"],
    },
    {
      mode: "visual",
      id: "entry-teaser.visual.style",
      title: "Style",
      role: "visual",
      writablePaths: ["style.surface", "style.border", "style.radius", "style.spacing"],
    },
    {
      mode: "visual",
      id: "entry-teaser.visual.cta-behavior",
      title: "CTA behavior",
      role: "content",
      writablePaths: ["cta.label", "cta.hrefMode", "cta.href", "cta.opensInNewTab", "cta.style"],
    },
    {
      mode: "visual",
      ...
      role: "content",
      writablePaths: ["fallback.title", "fallback.description", "fallback.fallbackToLatest"],
    },
    {
      mode: "advanced",

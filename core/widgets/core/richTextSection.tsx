...
export const richTextSectionEditorContract: WidgetEditorContract = {
  ...
  sections: [
      ...
      allowedDuplicateWritablePaths: [
        {
          path: "variant",
          reason:
            "Wizard seeds the initial rich text layout while Visual remains the daily owner after setup.",
          expiresWithTask: "TASK-339",
        },
      ],
      readOnlyPaths: ["body.blocks"],
    },
    {
      mode: "visual",
      ...
      role: "visual",
      writablePaths: ["variant", "options.maxWidth"],
      allowedDuplicateWritablePaths: [
        {
          path: "variant",
          reason:
    ...
    },
    {
      ...
      role: "content",
      writablePaths: ["titleBlock.eyebrow", "titleBlock.title", "titleBlock.headingLevel"],
    },
    {
      mode: "visual",
      ...
      title: "Body content",
      role: "content",
      writablePaths: ["body.html", "options.outputMode"],
    },
    {
      mode: "visual",
    ...
    },
    {
      ...
      role: "content",
      writablePaths: ["options.dropcap", "options.toc"],
    },
    {
      mode: "visual",
    ...
    },
    {
      ...
      role: "diagnostics",
      writablePaths: [],
      readOnlyPaths: ["runtime.sanitizer", "body.html"],
    },
    {
      mode: "advanced",

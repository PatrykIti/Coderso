...
| **§3.4 Brak edycji in‑place na canvasie** | HIGH (prio) | TASK‑422 + TASK‑469 | `pageInlineEditContract` + hook tekstowy renderera; changelog 1162. Rich‑text residuum domknięte przez TASK‑469: `format:"rich"` text blocks inline‑edit on canvas and commit through the shared rich‑text sanitizer instead of `stripInlineMarkup`. | ✅ **CLOSED** |

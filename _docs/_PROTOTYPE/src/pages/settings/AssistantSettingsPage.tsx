...
const FEATURE_ROWS = [
  {
    ...
    desc: "Inline drafting and rewrite suggestions while you type.",
    on: true,
  },
  ...
  return (
    <SettingsLayout title="Assistant" description="AI writing assistant configuration.">
      <div className="divide-y divide-border">
        ...
        <SettingsSection
          title="Behavior"
          description="Tune tone and ground rules for the assistant."
        >
          <div className="flex flex-col gap-4">
            ...
            <SettingsField
              label="System prompt"
              hint="Guidance prepended to every assistant request."
            >
              <Textarea
                rows={4}
        ...
        <SettingsSection title="Usage" description="Token consumption against your monthly plan.">
          <div className="flex flex-col gap-3">
            ...
            <p className="text-xs text-muted-foreground">
              Resets on the 1st. 38% of your monthly allowance remaining.
            </p>
          </div>
        </SettingsSection>
      </div>

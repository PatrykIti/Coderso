...
- capability registry/composer foundation:
  ...
  - assistant-facing page section aliases and merge slots now resolve through a deterministic library over the current page-builder widget registry and module pack coverage; unsupported aliases stay gated instead of inventing a second section catalog

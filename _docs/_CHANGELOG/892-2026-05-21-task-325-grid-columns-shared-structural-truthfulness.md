...
- Visual now shows current desktop/tablet/mobile totals from the effective visible live layout and explains whether each breakpoint fills one row, wraps onto additional rows, or leaves unused width.
...
- The review-loop hardening also aligned asymmetric preset behavior for 4-6 columns and made totals follow live slot count plus breakpoint visibility.

# 1237 - TASK-523 Page Canvas Background & Occlusion-Proof Cursor Spotlight — Per-Page `settings.background` + Additive Screen-Blend Spotlight (visible over opaque sections, nav-safe, reduced-motion-safe)

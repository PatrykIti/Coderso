...
- Follow-up `TASK-190-08-04` reran `bun run test:assistant:live` after explicit
  user approval for the opt-in external provider transfer; see changelog `835`
  for the live matrix harness fix and final green status.

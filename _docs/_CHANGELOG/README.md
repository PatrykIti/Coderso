...
Changelog 1248 is consumed by the completed TASK-536 family. Changelogs 1249–1257
remain reserved, respectively, for the implementation closure of TASK-537, TASK-538,
TASK-539, TASK-540, TASK-541, TASK-542, TASK-543, TASK-544, and TASK-545. These
remaining numbers are contract reservations only: do not add index rows or changelog
files before the corresponding family is complete. Use 1258 for the next unreserved
changelog entry.

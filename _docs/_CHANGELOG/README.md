...
Ordinary new entries continue after the highest existing number (`1326` as of
2026-08-26); check the consumption/reservation notes under `## Index` before allocating one.

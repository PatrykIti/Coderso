...
Ordinary new entries continue at 1101.
...
assistant policy coverage fix. Use 1101 for the next changelog entry.

| No. | Date | Title | Type |
|-----|------|-------|------|
| 1100 | 2026-06-06 | Navigation runtime and page editor canvas | CMS Widgets/Navigation/Admin UI/Page Builder/Runtime/QA/Docs |

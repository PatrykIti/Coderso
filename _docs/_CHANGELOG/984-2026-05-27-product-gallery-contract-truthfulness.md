# 984 - Product Gallery contract truthfulness

Date: 2026-05-27
Version: Unreleased
Tasks: TASK-339, TASK-339-12

## Key Changes

- Synchronized the Product Gallery widget contract to the richer sectioned
  Wizard, Visual, and Advanced editor UI that now ships in the admin.
- Moved Product Gallery variant ownership into a widget-owned `Variant and

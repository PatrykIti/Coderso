# RAPORT: Split Layout Widget — current-state weryfikacja
> **Status:** Passed
> **Data:** 2026-05-27
...
> **Referencja historyczna:** `_docs/PLAYWRIGHT/23-05-2026-22-18/REPORT_SPLIT_LAYOUT_WIDGET.md`
---
## 1. Zakres
- **Typ widgetu:** `split-layout`
- **Fixture admin:** `/ctr-split-layout-2305`
- **Fixture public:** `/test-split-layout-0516`
...
- Public path `/test-split-layout-0516` odpowiedzial `200`; overflow: `no`.
## 3. Co dziala
...
- Public route `/test-split-layout-0516` returns `200` and shows no unmarked overflow.

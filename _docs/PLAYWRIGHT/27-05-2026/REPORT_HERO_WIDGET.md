# RAPORT: Hero Widget — current-state weryfikacja
> **Status:** Passed
> **Data:** 2026-05-27
...
> **Referencja historyczna:** `_docs/PLAYWRIGHT/23-05-2026-22-18/REPORT_HERO_WIDGET.md`
---
## 1. Zakres
- **Typ widgetu:** `hero`
- **Fixture admin:** `/ctr-hero-2305`
- **Fixture public:** `/homepage`
- **Tryby weryfikowane:** `visual`, `advanced`
## 2. Wynik clean smoke
- **Admin status:** `passed`
- `visual`: status `passed`, roots `1`, visible sections `13`, declared sections `13`.
- `advanced`: status `passed`, roots `1`, visible sections `8`, declared sections `8`.
- **Public status:** `passed`
- Public path `/homepage` odpowiedzial `200`; overflow: `no`.
## 3. Co dziala
...
- Public route `/homepage` returns `200` and shows no unmarked overflow.

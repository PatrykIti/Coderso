# RAPORT: Listing Filters Widget — current-state weryfikacja
> **Status:** Passed
> **Data:** 2026-05-27
...
> **Referencja historyczna:** `_docs/PLAYWRIGHT/23-05-2026-22-18/REPORT_LISTING_FILTERS_WIDGET.md`
---
## 1. Zakres
- **Typ widgetu:** `listing-filters`
- **Fixture admin:** `/ctr-listing-filters-2305`
- **Fixture public:** `/test-listing-filters-0516`
- **Tryby weryfikowane:** `visual`, `advanced`
## 2. Wynik clean smoke
- **Admin status:** `passed`
- `visual`: status `passed`, roots `1`, visible sections `6`, declared sections `6`.
- `advanced`: status `passed`, roots `1`, visible sections `6`, declared sections `6`.
- **Public status:** `passed`
- Public path `/test-listing-filters-0516` odpowiedzial `200`; overflow: `no`.
## 3. Co dziala
...
- Public route `/test-listing-filters-0516` returns `200` and shows no unmarked overflow.

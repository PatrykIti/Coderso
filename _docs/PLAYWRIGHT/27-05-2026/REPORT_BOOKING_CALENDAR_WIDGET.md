# RAPORT: Booking Calendar Widget — current-state weryfikacja
> **Status:** Passed
> **Data:** 2026-05-27
...
> **Referencja historyczna:** `_docs/PLAYWRIGHT/23-05-2026-22-18/REPORT_BOOKING_CALENDAR_WIDGET.md`
---
## 1. Zakres
- **Typ widgetu:** `booking-calendar`
- **Fixture admin:** `/ctr-booking-calendar-2305`
- **Fixture public:** `/test-booking-calendar-0516`
...
- Public path `/test-booking-calendar-0516` odpowiedzial `200`; overflow: `no`.
## 3. Co dziala
...
- Public route `/test-booking-calendar-0516` returns `200` and shows no unmarked overflow.

# RAPORT: Newsletter Widget — current-state weryfikacja
> **Status:** Passed
> **Data:** 2026-05-27
...
> **Referencja historyczna:** `_docs/PLAYWRIGHT/23-05-2026-22-18/REPORT_NEWSLETTER_WIDGET.md`
---
## 1. Zakres
- **Typ widgetu:** `newsletter`
- **Fixture admin:** `/ctr-newsletter-2305`
- **Fixture public:** `/test-newsletter-widget-0516`
...
- Public path `/test-newsletter-widget-0516` odpowiedzial `200`; overflow: `no`.
## 3. Co dziala
...
- Public route `/test-newsletter-widget-0516` returns `200` and shows no unmarked overflow.

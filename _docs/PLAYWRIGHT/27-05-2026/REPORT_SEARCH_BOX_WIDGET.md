# RAPORT: Search Box Widget — current-state weryfikacja
> **Status:** Passed
> **Data:** 2026-05-27
...
> **Referencja historyczna:** `_docs/PLAYWRIGHT/23-05-2026-22-18/REPORT_SEARCH_BOX_WIDGET.md`
---
## 1. Zakres
- **Typ widgetu:** `search-box`
- **Fixture admin:** `/ctr-search-box-2305`
- **Fixture public:** `/ctr-search-box-2305`
- **Tryby weryfikowane:** `visual`, `advanced`
## 2. Wynik clean smoke
- **Admin status:** `passed`
- `visual`: status `passed`, roots `1`, visible sections `5`, declared sections `5`.
- `advanced`: status `passed`, roots `1`, visible sections `5`, declared sections `5`.
- **Public status:** `passed`
- Public path `/ctr-search-box-2305` odpowiedzial `200`; overflow: `no`.
## 3. Co dziala
...
- Public route `/ctr-search-box-2305` returns `200` and shows no unmarked overflow.

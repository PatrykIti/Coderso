# RAPORT: Stats KPI Widget — current-state weryfikacja
> **Status:** Passed
> **Data:** 2026-05-27
...
> **Referencja historyczna:** `_docs/PLAYWRIGHT/23-05-2026-22-18/REPORT_STATS_KPI_WIDGET.md`
---
## 1. Zakres
- **Typ widgetu:** `stats-kpi`
- **Fixture admin:** `/ctr-stats-kpi-2305`
- **Fixture public:** `/stats-kpi-audit-0516`
...
- Public path `/stats-kpi-audit-0516` odpowiedzial `200`; overflow: `no`.
## 3. Co dziala
...
- Public route `/stats-kpi-audit-0516` returns `200` and shows no unmarked overflow.

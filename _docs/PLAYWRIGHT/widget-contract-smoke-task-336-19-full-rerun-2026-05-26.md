...
- **Generated:** 2026-05-26T16:54:37.487Z
- **Dry run:** no
- **Inventory:** 38/38 widgets
- **Admin:** http://localhost:5173/admin
- **Frontend:** http://localhost:3000
- **Playwright session:** task-336-19-full-rerun-2026-05-26
...
| `accordion` | fixture-gap | visual:passed r1/s6/v6<br>advanced:fixture-gap r0/s0/v0 (admin_fixture_unopenable:block_select_missing) | - | - |
...
| `divider` | fixture-gap | visual:passed r1/s6/v6<br>advanced:fixture-gap r0/s0/v0 (admin_fixture_unopenable:block_select_missing) | - | - |
...
| `feature-grid` | fixture-gap | visual:passed r1/s8/v8<br>advanced:fixture-gap r0/s0/v0 (admin_fixture_unopenable:block_select_missing) | - | - |
| `testimonials` | metadata-gap | visual:passed r1/s9/v9<br>advanced:passed r1/s5/v5 | - | - |
| `pricing-plans` | passed | visual:passed r1/s8/v8<br>advanced:passed r1/s5/v5 | - | - |
| `faq-accordion` | fixture-gap | visual:passed r1/s9/v9<br>advanced:fixture-gap r0/s0/v0 (admin_fixture_unopenable:block_select_missing) | - | - |
...
| `gallery-mosaic` | fixture-gap | visual:passed r1/s9/v9<br>advanced:fixture-gap r0/s0/v0 (admin_fixture_unopenable:block_select_missing) | - | - |
| `stats-kpi` | passed | visual:passed r1/s8/v8<br>advanced:passed r1/s5/v5 | - | - |
| `team` | metadata-gap | visual:passed r1/s6/v6<br>advanced:passed r1/s6/v6 | - | - |
| `rich-text-section` | fixture-gap | visual:passed r1/s8/v8<br>advanced:fixture-gap r0/s0/v0 (admin_fixture_unopenable:block_select_missing) | - | - |
...
| `entry-teaser` | fixture-gap | visual:passed r1/s10/v10<br>advanced:fixture-gap r0/s0/v0 (admin_fixture_unopenable:block_select_missing) | - | - |
...
| `product-table` | fixture-gap | visual:fixture-gap r0/s0/v0 (admin_fixture_unopenable:block_select_missing)<br>advanced:passed r1/s4/v4 | - | - |
| `listing-filters` | passed | visual:passed r1/s6/v6<br>advanced:passed r1/s6/v6 | - | - |
| `search-box` | fixture-gap | visual:passed r1/s5/v5<br>advanced:fixture-gap r0/s0/v0 (admin_fixture_unopenable:block_select_missing) | - | - |
| `timeline` | passed | visual:passed r1/s8/v8<br>advanced:passed r1/s5/v5 | - | - |
| `compare-timeline` | passed | visual:passed r1/s9/v9<br>advanced:passed r1/s5/v5 | - | - |
| `newsletter` | fixture-gap | visual:passed r1/s9/v9<br>advanced:fixture-gap r0/s0/v0 (admin_fixture_unopenable:block_select_missing) | - | - |
...
| `form-embed` | fixture-gap | visual:passed r1/s9/v9<br>advanced:fixture-gap r0/s0/v0 (admin_fixture_unopenable:block_select_missing) | - | - |
| `contact` | passed | visual:passed r1/s10/v10<br>advanced:passed r1/s5/v5 | - | - |
| `navigation` | metadata-gap | visual:passed r1/s5/v5<br>advanced:passed r1/s3/v3 | - | - |
| `footer` | fixture-gap | visual:passed r1/s12/v12<br>advanced:fixture-gap r0/s0/v0 (admin_fixture_unopenable:block_select_missing) | - | - |

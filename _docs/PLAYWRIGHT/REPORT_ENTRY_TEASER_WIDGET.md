...
jest finalnym matrixem closure po wdrożeniu `TASK-265`, `TASK-293`, i
powiązanych leafów.
...
| E-14 | Fixed | TASK-265-06 + TASK-293 | shared swatch-plus-text `SharedColorControl` dla surface/border + widget-local adoption test |

...
- Footer Visual/Advanced controls are labeled, `sectionPaddingY` has one owner,
  link reorder is supported, and Footer matches the intended clear/reset +
  color-picker UX while helper-level convergence remains tracked in
  `TASK-310-03`.
...
| 112-116, 176-180, 182, 264, 267-270, 332-333, 401-402 | Footer editor labels were inconsistent; `sectionPaddingY` was duplicated; Footer had not adopted shared clear/reset/color-picker patterns | `fixed` | `TASK-268-04`, `TASK-268-05` | Visual/Advanced fields are labeled, Advanced is one-control-per-line, `sectionPaddingY` exists only in Advanced, and Footer now matches the intended clear/reset + color picker UX. The later helper-level convergence remains tracked in `TASK-310-03`. [footer-editor-wave.test.tsx](/Users/pciechanski/Documents/_moje_projekty/Coderso/tests/vitest/ui/footer-editor-wave.test.tsx:1) covers label-driven selectors instead of placeholder-only lookups. |
...
| 225-226, 230, 413, 415 | Newsletter/address/contact/back-to-top backlog | `deferred` | `TASK-309-01`, `TASK-309-02`, `TASK-309-03` | Newsletter now routes to [TASK-309-01](/Users/pciechanski/Documents/_moje_projekty/Coderso/_docs/_TASKS/TASK-309-01_Footer_Newsletter_Composition_and_Submission_Contract.md:1), address/contact to [TASK-309-02](/Users/pciechanski/Documents/_moje_projekty/Coderso/_docs/_TASKS/TASK-309-02_Footer_Address_and_Contact_Utility_Surface.md:1), and back-to-top to [TASK-309-03](/Users/pciechanski/Documents/_moje_projekty/Coderso/_docs/_TASKS/TASK-309-03_Footer_Back_to_Top_Runtime_Policy.md:1). |

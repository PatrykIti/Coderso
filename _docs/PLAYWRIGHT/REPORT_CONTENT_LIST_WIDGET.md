...
| E-05 | fixed | `TASK-302` | `textColor` now uses the shared clear/picker contract |
...
| E-08 | fixed | `TASK-302` | Content List color controls now include a picker without losing CSS-token text input ownership |

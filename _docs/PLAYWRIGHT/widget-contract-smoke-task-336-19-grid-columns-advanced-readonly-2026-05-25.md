...
- **Generated:** 2026-05-25T14:28:30.545Z
- **Dry run:** no
- **Inventory:** 38/38 widgets
- **Admin:** http://localhost:5173/admin
- **Frontend:** http://localhost:3000
- **Playwright session:** task-336-19-grid-columns-final
...
|---|---|---|---|---|
| `grid-columns` | passed | visual:passed r1/s6/v6<br>advanced:passed r1/s3/v3 | - | - |

...
- **Generated:** 2026-05-26T17:41:27.299Z
- **Dry run:** no
- **Inventory:** 38/38 widgets
- **Admin:** http://localhost:5173/admin
- **Frontend:** http://localhost:3000
- **Playwright session:** task-336-19-full-rerun-2026-05-26-fixed
...
| `split-layout` | fixture-gap | visual:fixture-gap r0/s0/v0 (admin_fixture_unopenable:block_select_missing)<br>advanced:passed r1/s4/v4 | - | - |
...
| `toggle-block` | fixture-gap | visual:fixture-gap r0/s0/v0 (admin_fixture_unopenable:block_select_missing)<br>advanced:passed r1/s5/v5 | - | - |
...
| `stack` | fixture-gap | visual:fixture-gap r0/s0/v0 (admin_fixture_unopenable:block_select_missing)<br>advanced:passed r1/s4/v4 | - | - |
...
| `testimonials` | fixture-gap | visual:fixture-gap r0/s0/v0 (admin_fixture_unopenable:block_select_missing)<br>advanced:passed r1/s5/v5 | - | - |
...
| `cta-banner` | fixture-gap | visual:fixture-gap r0/s0/v0 (admin_fixture_unopenable:block_select_missing)<br>advanced:passed r1/s3/v3 | - | - |
...
| `stats-kpi` | fixture-gap | visual:fixture-gap r0/s0/v0 (admin_fixture_unopenable:block_select_missing)<br>advanced:passed r1/s5/v5 | - | - |
...
| `content-list` | fixture-gap | visual:fixture-gap r0/s0/v0 (admin_fixture_unopenable:block_select_missing)<br>advanced:passed r1/s5/v5 | - | - |
...
| `product-gallery` | fixture-gap | visual:fixture-gap r0/s0/v0 (admin_fixture_unopenable:block_select_missing)<br>advanced:passed r1/s6/v6 | - | - |

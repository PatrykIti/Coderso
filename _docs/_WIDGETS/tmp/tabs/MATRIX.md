...
|---|---|---|
| Keep | Items with trigger and panel content from Radix, Chakra, Mantine, and React Aria. | Model tabs as repeatable `items[]` with stable ids, labels, and panel slots/content; optional badges/icons remain Adapt below unless schema/defaults/render/editor/tests move together. |

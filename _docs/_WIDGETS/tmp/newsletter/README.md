...
| Preline newsletter examples | https://preline.co/examples/newsletter-signup.html | docs-example | Terms require verification. | Newsletter CTA with email field, consent note, and background section. | `consent.label`, `style.surface`, `copy.privacyNote`. | Adapt | Summarize only. |

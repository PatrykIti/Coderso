...
|---|---|---|
| Keep | Orientation, style variant, color/tone, and spacing from WordPress, Chakra, Mantine, MUI, and daisyUI. | Expose a compact Visual section with orientation, variant, tone, width/thickness, and spacing tokens. |

...
|---|---|---|
| Keep | Column count, gap, and responsive stacking from WordPress, Chakra, and Mantine. | Expose `columns`, `gap`, `rowGap`, and `mobileStack` as primary Visual controls; MUI span/offset behavior remains Adapt below. |

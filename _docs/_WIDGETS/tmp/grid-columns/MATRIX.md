...
|---|---|---|
| Keep | Column count, gap, and responsive stacking from WordPress, Chakra, Mantine, and MUI. | Expose `columns`, `gap`, `rowGap`, and `mobileStack` as primary Visual controls. |

...
| Field visibility toggles | WordPress Latest Posts | Keep | Visual `Fields` section for image, excerpt, meta, and CTA; taxonomy/tags stay inside current `showMeta` output unless a future `showTaxonomy` owner is added. |

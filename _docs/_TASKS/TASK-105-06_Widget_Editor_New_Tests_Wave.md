...
Current `2026-03-10` widget editor snapshot after the latest hero/content/section follow-up:
...
- aggregate `core/admin/ui/widgets/editors/*` -> `95.97%` lines / `69.72%` branches across `40` tracked files

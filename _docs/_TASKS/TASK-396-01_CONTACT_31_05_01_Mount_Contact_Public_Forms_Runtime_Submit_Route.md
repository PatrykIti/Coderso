# TASK-396-01: CONTACT-31-05-01 - Mount Contact public Forms runtime submit route
# FileName: TASK-396-01_CONTACT_31_05_01_Mount_Contact_Public_Forms_Runtime_Submit_Route.md
...
Execution-ready leaf task for CONTACT-31-05-01 from `_docs/PLAYWRIGHT/31-05-2026-widgets/REPORT_CONTACT_WIDGET.md` and parent `TASK-396`.
...
**Helper/function shape:** Register/reuse public forms submit endpoint for Contact runtime and map domain errors.
...
**Regression-test shape:** Route registration and Contact public submit tests.
...
- `git diff --check`
- Focused regression: Route registration and Contact public submit tests.
...
- CONTACT-31-05-01 is fixed or reclassified with fresh evidence in the report and parent task.

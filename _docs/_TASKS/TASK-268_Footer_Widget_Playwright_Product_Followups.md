...
|---|---|---|---|
| TASK-268-01 | Social rows only: report lines 67-71, 91-95, 99-103, 181, 191, 193, 207-208, 217, 220-221, 271, 318, 321, 383, 386, 403, 427, 433, and 446. | `core/widgets/core/footer.tsx`, `core/admin/ui/widgets/editors/FooterEditors.tsx`, `tests/vitest/widgets/footer.test.tsx`, `tests/vitest/ui/footer-editor-wave.test.tsx` | Vitest widget render, UI editor wave, renderer smoke when public output changes, validator test when schema changes |

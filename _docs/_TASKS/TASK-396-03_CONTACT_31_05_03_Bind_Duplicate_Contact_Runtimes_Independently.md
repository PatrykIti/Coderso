# TASK-396-03: CONTACT-31-05-03 - Bind duplicate Contact runtimes independently
# FileName: TASK-396-03_CONTACT_31_05_03_Bind_Duplicate_Contact_Runtimes_Independently.md
...
Execution-ready leaf task for CONTACT-31-05-03 from `_docs/PLAYWRIGHT/31-05-2026-widgets/REPORT_CONTACT_WIDGET.md` and parent `TASK-396`.

Second Contact runtime on page does not bind.

Status log:

- 2026-06-02: Moved to In Progress with TASK-396 Contact remediation.
- 2026-06-02: Done. CONTACT-31-05-03 / CT-31-05-03 is closed by the
  idempotent shared Forms runtime binder introduced in TASK-395 and verified
  in the Contact lane.

## Sub-Tasks

- [x] Reproduce CONTACT-31-05-03 with the report fixture before editing and record the observed admin/public state in closure notes.
...
**Helper/function shape:** Make runtime idempotent across all roots and instance ids.
...
**Regression-test shape:** Runtime test with two Contact widgets.
...
- `git diff --check`
- Focused regression: Runtime test with two Contact widgets.
...
- CONTACT-31-05-03 is fixed or reclassified with fresh evidence in the report and parent task.
...
- The shared runtime now exposes and re-invokes `window.__nextlessFormRuntimeBind`.
- Duplicate/later Contact Forms runtime instances bind through the same
  idempotent code path as Form Embed.

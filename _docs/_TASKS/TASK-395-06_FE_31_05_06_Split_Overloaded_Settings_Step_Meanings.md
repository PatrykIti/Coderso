# TASK-395-06: FE-31-05-06 - Split overloaded `settings.step` meanings
# FileName: TASK-395-06_FE_31_05_06_Split_Overloaded_Settings_Step_Meanings.md
...
- [ ] Reproduce FE-31-05-06 with the report fixture before editing and record the observed admin/public state in closure notes.
...
**Helper/function shape:** Introduce explicit fields such as `settings.progressStep` and `settings.inputStep` with backward-compatible adapter.
...
**Regression-test shape:** Normalizer migration tests for legacy payloads.
...
- `git diff --check`
- Focused regression: Normalizer migration tests for legacy payloads.
...
- FE-31-05-06 is fixed or reclassified with fresh evidence in the report and parent task.

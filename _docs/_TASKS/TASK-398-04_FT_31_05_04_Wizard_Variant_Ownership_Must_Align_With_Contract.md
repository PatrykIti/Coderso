# TASK-398-04: FT-31-05-04 - Wizard variant ownership must align with contract
# FileName: TASK-398-04_FT_31_05_04_Wizard_Variant_Ownership_Must_Align_With_Contract.md
...
Execution-ready leaf task for FT-31-05-04 from `_docs/PLAYWRIGHT/31-05-2026-widgets/REPORT_FOOTER_WIDGET.md` and parent `TASK-398`.
...
**Regression-test shape:** Editor contract regression for Wizard/Visual ownership.
...
- `git diff --check`
- Focused regression: Editor contract regression for Wizard/Visual ownership.
...
- FT-31-05-04 is fixed or reclassified with fresh evidence in the report and parent task.

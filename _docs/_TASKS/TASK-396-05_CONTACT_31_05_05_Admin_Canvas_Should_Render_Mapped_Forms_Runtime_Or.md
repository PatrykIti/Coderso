# TASK-396-05: CONTACT-31-05-05 - Admin canvas should render mapped Forms runtime or explicit boundary
# FileName: TASK-396-05_CONTACT_31_05_05_Admin_Canvas_Should_Render_Mapped_Forms_Runtime_Or.md
...
Execution-ready leaf task for CONTACT-31-05-05 from `_docs/PLAYWRIGHT/31-05-2026-widgets/REPORT_CONTACT_WIDGET.md` and parent `TASK-396`.
...
**Helper/function shape:** Render an admin-safe non-submitting preview of the mapped Contact form fields when the Forms runtime resolves; if the mapping cannot resolve, render explicit noninteractive boundary copy tied to the same diagnostics shown in Advanced.
...
**Regression-test shape:** Admin UI test for mapped forms preview state.
...
- `git diff --check`
- Focused regression: Admin UI test for mapped forms preview state.
...
- CONTACT-31-05-05 is fixed or reclassified with fresh evidence in the report and parent task.

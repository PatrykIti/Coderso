...
|---|---|
| `core/widgets/core/richTextSection.tsx` | Repair article max-width at lines 573-577, title heading render at lines 551-562, section labeling at lines 536-549, and TOC link focus style at lines 468-470. |
...
- Duplicate section title ids must be stable per rendered widget instance; if a
  ...
  deterministic slug with collision avoidance inside this component.

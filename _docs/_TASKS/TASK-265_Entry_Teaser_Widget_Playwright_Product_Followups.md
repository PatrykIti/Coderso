...
- Entry Teaser adoption of the shared color-control hook for surface/border
  fields after TASK-293 defines the generic swatch-plus-text contract.
...
- Generic `Clear`, `none`, and closed token semantics remain owned by
  ...
  TASK-293; TASK-265-06 may only adopt that shared control for Entry Teaser
...
| E-14 | TASK-265-06 after TASK-293 defines the shared color-control hook |
...
| TASK-265-06 | Report section 3.2 E-14 | `EntryTeaserEditors.tsx:889-948`, `entryTeaser.tsx:474-478`, shared TASK-293 color-control hook | Vitest editor wave, Vitest widget render suite once introduced, Bun widget suite until migration lands, shared color-control tests from TASK-293 if touched |
...
6. Complete TASK-265-06 after TASK-293 lands the shared color-control

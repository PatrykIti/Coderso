# TASK-392-01: NL-31-05-01 - Normalize bound Forms runtime fields before admin preview
# FileName: TASK-392-01_NL_31_05_01_Normalize_Bound_Forms_Runtime_Fields_Before_Admin_Preview.md
...
Execution-ready leaf task for NL-31-05-01 from `_docs/PLAYWRIGHT/31-05-2026-widgets/REPORT_NEWSLETTER_WIDGET.md` and parent `TASK-392`.

Forms runtime preview breaks on unnormalized fields/schema drift.
...
**Helper/function shape:** Project Newsletter form bindings through the same normalized Forms runtime shape used by public rendering before admin preview consumes it.
...
**Regression-test shape:** Admin preview regression for bound Forms runtime with schema-normalized fields.
...
- `git diff --check`
- Focused regression: Admin preview regression for bound Forms runtime with schema-normalized fields.
...
- NL-31-05-01 is fixed or reclassified with fresh evidence in the report and parent task.

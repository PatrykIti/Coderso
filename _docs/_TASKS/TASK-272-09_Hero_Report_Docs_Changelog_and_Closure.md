...
fixed by the current landed shared owner, fixed by TASK-272, classified as
page-shell scope, or intentionally deferred.
...
| `_docs/_CHANGELOG/{N}-YYYY-MM-DD-task-272-hero-widget-followups.md` | Add the final changelog entry using the actual closeout date. |
...
const findingMap = [
  ...
  { id: "BUG-02", status: "fixed-shared", evidence: "TASK-256-02 / TASK-310-02 validation" },
  ...
  { id: "BUG-06", status: "fixed-shared", evidence: "TASK-256-06-03 validation" },
  { id: "BUG-07", status: "fixed-task-272", evidence: "TASK-272-02 validation" },
  { id: "UX-01", status: "fixed-shared", evidence: "TASK-305 / TASK-310-02 validation" },
  { id: "UX-02", status: "fixed-shared", evidence: "TASK-305 / TASK-310-02 validation" },
  ...
  { id: "UX-07", status: "fixed-shared", evidence: "TASK-256-02 / TASK-310-02 validation" },
  ...
  { id: "A2", status: "fixed-task-272", evidence: "TASK-272-06 adoption of TASK-299 validation" },
  { id: "A3", status: "fixed-shared", evidence: "TASK-256-06-03 validation" },
  { id: "A4", status: "fixed-shared", evidence: "TASK-256-06-03 validation" },
...
- Verify shared findings cite the current landed post-TASK-256 owners
  (`TASK-299`, `TASK-305`, `TASK-310-02`, etc.) instead of assuming every
  non-Hero fix still routes through the old umbrella.
...
- Shared report rows cite the current landed shared owners where applicable.

# TASK-393-04: BC-31-05-04 - Unify admin/public preview catalog filtering
# FileName: TASK-393-04_BC_31_05_04_Unify_Admin_Public_Preview_Catalog_Filtering.md
...
Execution-ready leaf task for BC-31-05-04 from `_docs/PLAYWRIGHT/31-05-2026-widgets/REPORT_BOOKING_CALENDAR_WIDGET.md` and parent `TASK-393`.

Admin preview filters inactive/unlinked rows differently from public preview resolver.

## Sub-Tasks

- [x] Reproduce BC-31-05-04 with the report fixture before editing and record the observed admin/public state in closure notes.
...
- Added pure `buildBookingRuntimeCatalog` filtering for active resources, active services, and active service-resource links, then reused it in admin preview and public runtime resolver.
- Added parity regression coverage proving admin preview and the shared runtime catalog produce the same visible service/resource lists while filtering inactive and unlinked rows.
...
**Regression-test shape:** Test inactive service/resource and unlinked service: admin canvas and public preview match or expose documented diagnostic divergence.

## Owner Files

- `core/admin/services/bookingCalendarPreview.ts`
...
- `git diff --check`
- Focused regression: Test inactive service/resource and unlinked service: admin canvas and public preview match or expose documented diagnostic divergence.
...
- BC-31-05-04 is fixed or reclassified with fresh evidence in the report and parent task.

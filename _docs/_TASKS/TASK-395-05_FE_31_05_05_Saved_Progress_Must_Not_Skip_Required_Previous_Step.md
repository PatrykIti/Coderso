# TASK-395-05: FE-31-05-05 - Saved progress must not skip required previous-step fields
# FileName: TASK-395-05_FE_31_05_05_Saved_Progress_Must_Not_Skip_Required_Previous_Step.md
...
- [ ] Reproduce FE-31-05-05 with the report fixture before editing and record the observed admin/public state in closure notes.
...
**Helper/function shape:** Revalidate all required fields up to current step before restoring/advancing; clamp saved step to first invalid step.
...
**Regression-test shape:** Runtime test restoring progress with missing required earlier fields.
...
- `git diff --check`
- Focused regression: Runtime test restoring progress with missing required earlier fields.
...
- FE-31-05-05 is fixed or reclassified with fresh evidence in the report and parent task.

# TASK-394-04: AF-31-05-04 - Widget custom success copy must outrank API default
# FileName: TASK-394-04_AF_31_05_04_Widget_Custom_Success_Copy_Must_Outrank_API_Default.md
...
**Helper/function shape:** Client should prefer widget dataset success copy and use API runtime copy only as fallback, or API should omit generic default.
...
**Regression-test shape:** Runtime test for custom widget success copy after successful API response.
...
- `git diff --check`
- Focused regression: Runtime test for custom widget success copy after successful API response.
...
- AF-31-05-04 is fixed or reclassified with fresh evidence in the report and parent task.

# TASK-383-02: PF-31-05-02 - Add seeded posts fixture for browser-level display controls
# FileName: TASK-383-02_PF_31_05_02_Add_Seeded_Posts_Fixture_For_Browser_Level_Display.md
...
Execution-ready leaf task for PF-31-05-02 from `_docs/PLAYWRIGHT/31-05-2026-widgets/REPORT_POSTS_FEED_WIDGET.md` and parent `TASK-383`.

The audit source resolved zero posts, so display toggles, images, featured/manual selection, pagination, colors, and CTA were not browser-proven.
...
**Helper/function shape:** Seed at least three posts including featured, image, author/date, tag/category, detail/list routes, and enough count for load-more.
...
**Regression-test shape:** Posts Feed populated Playwright smoke.
...
- `git diff --check`
- Focused regression: Posts Feed populated Playwright smoke.
...
- PF-31-05-02 is fixed or reclassified with fresh evidence in the report and parent task.

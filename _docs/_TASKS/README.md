...
| TASK-215-02-02 | Table View Selection and Pagination | High | Medium | Technical leaf: Pages-style checkbox table, three-dot row action menus, shared pagination, and visible-id selection trimming |

...
| TASK-281 | Product Table Widget Playwright Product Followups | High | Very Large | In progress (2026-05-21): four Product Table leaves are landed on dedicated worktrees, and the family remains active for accessibility, media/context columns, front-end controls, layout variants, diagnostics, and final closure sync |
---

...
| TASK-407-02 | Guided Intake Mode and Session Contract | High | Large | In progress (2026-06-05): shared Basic/Advanced intake contract started; L01 owns service-side mode, step, option, and media policy registries. |

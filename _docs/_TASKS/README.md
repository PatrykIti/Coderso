...
| TASK-407-05 | SiteKit Plan and Content Engine Decisions | High | Large | In progress (2026-06-05): L01 maps reviewed intake facts into schema-exact `context.siteKit`; L02 validates static shell coverage; L03 resolves content-engine decisions/gates; L04 resolves custom-screen editing surface decisions/gates; remaining leaves cover follow-ups and idempotency tests. |

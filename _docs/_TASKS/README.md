...
| TASK-407-06 | Admin UI Review and Prompt-Poisoning Hardening | High | Large | In progress (2026-06-06): intake state machine, Basic/Advanced controls, final review handoff, and warning/local-state redaction are complete; remaining work is legacy AI site wizard convergence. |

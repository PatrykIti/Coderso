...
| TASK-190-05-02 | Page Upsert Composition Adapter | High | Large | Done: catalog page sections now compose through the existing widget owner, canonical/supporting collection pages resolve reviewed locators into persisted `PageData.settings.collectionLink` ids, and cross-collection mismatches fail closed through the page owner seam |

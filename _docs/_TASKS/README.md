...
| TASK-170 | LLM Guide Action Family Expansion | High | Large | In progress: patch adapter leaves complete; closure is next |
| TASK-170-03 | Executor Adapters and Domain Service Reuse | High | Large | In progress: patch adapter leaves complete; closure is next |
| TASK-170-03-03 | Form, Page, and Listing Patch Executor Adapters | High | Large | In progress: listing, page, and form patch leaves complete; closure is next |

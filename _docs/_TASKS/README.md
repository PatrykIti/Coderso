...
| ID | Title | Priority | Effort | Notes |
|----|-------|----------|--------|-------|
| TASK-132 | Reviews Admin UI Assistant Documentation Refresh | Medium | Small | In progress: real UI walkthrough completed for the moderation screen; reviews is being separated from the old combined engagement doc while popups stays for a later pass |

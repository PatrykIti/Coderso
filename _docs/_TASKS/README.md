...
| TASK-170 | LLM Guide Action Family Expansion | High | Large | In progress: listing and page widget patches are complete; form automation is next |
| TASK-170-03 | Executor Adapters and Domain Service Reuse | High | Large | In progress: page widget patch complete; form automation and closure are next |
| TASK-170-03-03 | Form, Page, and Listing Patch Executor Adapters | High | Large | In progress: listing and page patch leaves complete; form automation is next |

...
| TASK-171 | LLM Guide Provider Planner Intelligence | High | Large | In progress: provider/local planner explanation is complete; fixture and route closure is next |

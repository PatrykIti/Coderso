...
| TASK-407-05 | SiteKit Plan and Content Engine Decisions | High | Large | In progress (2026-06-05): L01 maps reviewed intake facts into the existing schema-exact `context.siteKit`; remaining leaves add static actions, content engines, custom screens, follow-ups, and idempotency tests. |

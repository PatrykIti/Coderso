...
| TASK-358 | Admin Access Logs Report Remediation Family | High | Large | In progress (2026-06-01): TASK-358-01 implemented; session detail/revoke, export, and advanced filters remain. |
---

# TASK-364-01: SPL-31-05-01 - Phone ratio summary must respect stacked mobile mode
# FileName: TASK-364-01_SPL_31_05_01_Phone_Ratio_Summary_Must_Respect_Stacked_Mobile_Mode.md
...
Execution-ready leaf task for SPL-31-05-01 from `_docs/PLAYWRIGHT/31-05-2026-widgets/REPORT_SPLIT_LAYOUT_WIDGET.md` and parent `TASK-364`.

Advanced `Pane layout` can show a phone split ratio even when effective phone layout is stacked.
...
**Helper/function shape:** Resolve an effective phone layout helper first; if stacked, summarize as stacked and retain saved ratio only as dormant/saved state.
...
**Regression-test shape:** UI regression: stacked phone layout never reports an active split ratio without inactive copy.
...
- `git diff --check`
- Focused regression: UI regression: stacked phone layout never reports an active split ratio without inactive copy.
...
- SPL-31-05-01 is fixed or reclassified with fresh evidence in the report and parent task.

...
- [ ] Reproduce CONTACT-31-05-02 with the report fixture before editing and record the observed admin/public state in closure notes.
...
- `core/widgets/core/contactRuntime*.ts`

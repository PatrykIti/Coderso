...
| TASK-407-07-L04 | Follow Up Refinement and Fail Closed E2E | In Progress | Wire/prove guided follow-up resolver, scoped refinement, publish-aware runtime checks, and rejected unknown/poisoned/media-reference cases. |

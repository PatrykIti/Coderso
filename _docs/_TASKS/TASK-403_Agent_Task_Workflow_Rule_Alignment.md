# TASK-403: Agent Task Workflow Rule Alignment
# FileName: TASK-403_Agent_Task_Workflow_Rule_Alignment.md
...
- Branch/worktree isolation was noted by the audit; no branch switch was made
  ...
  otherwise clean before TASK-403 edits.
...
add changelog 1097 and index row
mark TASK-403 and board Done
run git diff --check
```
...
- Manual documentation review of `AGENTS.md`, `_docs/_TASKS/README.md`,
  `_docs/_TASKS/EXAMPLE_TASK.md`, and the TASK-403 changelog entry.

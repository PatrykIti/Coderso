...
- [x] Allocate the next migration number by re-reading
  ...
  the live journal at implementation time).
- [x] Author `core/db/migrations/0079_detail_page_v2_backfill.sql`:
...
- [x] Generate `core/db/migrations/meta/0079_snapshot.json` + update
...
|---|---|
| `core/db/migrations/0079_detail_page_v2_backfill.sql` | NEW backfill migration |
| `core/db/migrations/meta/0079_snapshot.json` | NEW snapshot |

...
- [x] Docs:
  ...
  - `_docs/DATA_MODEL.md` — `detail_page_documents` jsonb v2 contract,
    backfill `0079` + rollback/forward notes, revisions-not-backfilled note.
...
- `tests/unit/toolchain/bunLaneMigrate.test.ts`,
  ...
  count pinned at 77, but L03's migration `0079` makes the live journal 78;
  updated the pin to 78 (verified 78 = base 77 + S6's 0079).
...
4. Exempt generated/test metadata: `core/db/migrations/meta/0079_snapshot.json`

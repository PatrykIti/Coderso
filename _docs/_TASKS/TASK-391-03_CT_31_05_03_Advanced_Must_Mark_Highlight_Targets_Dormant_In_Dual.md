# TASK-391-03: CT-31-05-03 - Advanced must mark highlight targets dormant in `dual-track`
# FileName: TASK-391-03_CT_31_05_03_Advanced_Must_Mark_Highlight_Targets_Dormant_In_Dual.md
...
Execution-ready leaf task for CT-31-05-03 from `_docs/PLAYWRIGHT/31-05-2026-widgets/REPORT_COMPARE_TIMELINE_WIDGET.md` and parent `TASK-391`.

Runtime shows no segments/highlights in dual-track, but Advanced reports `Highlight target: Both tracks` as active.
...
**Helper/function shape:** Read active variant in Advanced and label saved highlight metadata as disabled/dormant unless `dual-track-highlight` is active.
...
**Regression-test shape:** UI regression: dual-track with saved targets includes dormant copy, not active-only summary.
...
- `git diff --check`
- Focused regression: UI regression: dual-track with saved targets includes dormant copy, not active-only summary.
...
- CT-31-05-03 is fixed or reclassified with fresh evidence in the report and parent task.

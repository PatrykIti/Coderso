...
| `core/admin/ui/widgets/editors/GalleryMosaicEditors.tsx` | 92-98, 448, 559-598, 720-832 | Overlay alpha-safe editing, current image/video type clarity, and Wizard video media picker scope. Duplicated Advanced-control cleanup stays in TASK-256-01; Visual per-item media picker is TASK-270-01. |

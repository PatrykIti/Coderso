...
| `logo-cloud` | `clear-required` | `logoCloud.tsx:323-370` renders repeated logo tiles; tile background is class-driven and needs a clearable tile-surface contract if exposed | TASK-244-04-01 | `tests/vitest/widgets/logoCloud.test.tsx`; `tests/vitest/ui/logo-cloud-editor-wave.test.tsx`; `_docs/_WIDGETS/LOGO_CLOUD.md` |
...
| `stats-kpi` | `clear-required` | `statsKpi.tsx:359-404` card variant uses forced card surfaces; editor `StatsKpiEditors.tsx` | TASK-244-04-01 | `tests/vitest/widgets/statsKpi.test.tsx`; `tests/vitest/ui/stats-kpi-editor-wave.test.tsx`; `_docs/_WIDGETS/STATS_KPI.md` |
...
| `screen-record-header` | `clear-required` | `screenRecordHeader.tsx:88-89`, `screenRecordHeader.tsx:107` force card/compact/pill surfaces | TASK-244-03-01 | `tests/vitest/widgets/screenWidgets.test.tsx`; `ScreenEditors.tsx`; `tests/vitest/ui/custom-screen-binding-panel.test.tsx`; `_docs/WIDGETS.md` |
| `screen-field-value` | `clear-required` | `screenFieldValue.tsx:80`, `screenFieldValue.tsx:99` force inline/stacked field surfaces | TASK-244-03-01 | `tests/vitest/widgets/screenWidgets.test.tsx`; `ScreenEditors.tsx`; `tests/vitest/ui/custom-screen-binding-panel.test.tsx`; `_docs/WIDGETS.md` |
| `screen-field-group` | `clear-required` | `screenFieldGroup.tsx:79-80`, `screenFieldGroup.tsx:105` force subtle/default and empty group surfaces | TASK-244-03-01 | `tests/vitest/widgets/screenWidgets.test.tsx`; `ScreenEditors.tsx`; `tests/vitest/ui/custom-screen-binding-panel.test.tsx`; `_docs/WIDGETS.md` |
| `screen-two-column` | `clear-required` | `screenTwoColumn.tsx:93`, `screenTwoColumn.tsx:111` force two-column frame and empty drop area backgrounds | TASK-244-03-01 | `tests/vitest/widgets/screenWidgets.test.tsx`; `ScreenEditors.tsx`; `tests/vitest/ui/custom-screen-binding-panel.test.tsx`; `_docs/_WIDGETS/SCREEN_TWO_COLUMN.md` |

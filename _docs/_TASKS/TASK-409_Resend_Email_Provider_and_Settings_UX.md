# TASK-409: Resend Email Provider and Settings UX (Index)
# FileName: TASK-409_Resend_Email_Provider_and_Settings_UX.md
...
- `TASK-409-01-Resend-Integration-Secret-Contract.md`
  - `TASK-409-01-L01-Resend-Connector-and-Secret-Storage.md`
  - `TASK-409-01-L02-Secret-Redaction-and-Key-Clear-State.md`
- `TASK-409-02-Email-Provider-Backend-Contract.md`
  - `TASK-409-02-L01-Provider-Settings-and-Normalization.md`
  - `TASK-409-02-L02-Provider-Transport-and-Delivery-Logs.md`
  - `TASK-409-02-L03-Form-Automation-Provider-Resolution.md`
- `TASK-409-03-Admin-API-and-Client-Contract.md`
  - `TASK-409-03-L01-Email-Settings-Routes-and-Error-Mapping.md`
  - `TASK-409-03-L02-Integrations-Routes-and-Admin-DTOs.md`
- `TASK-409-04-Admin-UX-Validation-and-Closure.md`
  - `TASK-409-04-L01-Email-Settings-Provider-UX.md`
  - `TASK-409-04-L02-Integrations-Provider-UX.md`
  - `TASK-409-04-L03-Validation-Docs-Changelog-and-Board-Closure.md`

---

## Implementation Order

1. Land `TASK-409-01-L01` and `TASK-409-01-L02` first so the Resend connector,
   secret redaction, and key-clear state exist before Email Settings can select
   Resend.
2. Land `TASK-409-02-L01` then `TASK-409-02-L02` so provider settings normalize
   before delivery resolves the active transport.
3. Land `TASK-409-02-L03` after the shared transport exists so Form Actions do
   not keep a hidden SMTP-only path.
4. Land `TASK-409-03-L01` and `TASK-409-03-L02` after backend contracts exist so
   route schemas, error mapping, audit metadata, and admin DTOs match the
   service behavior.
5. Land `TASK-409-04-L01` and `TASK-409-04-L02` after clients expose the new
   DTOs.
6. Land `TASK-409-04-L03` last with docs, changelog, final validation, board

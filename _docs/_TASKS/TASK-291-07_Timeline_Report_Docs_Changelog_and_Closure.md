...
- [ ] For NEW and W7, record exact TASK-256 physical owner tasks; never close
  them with broad `TASK-256` ownership only.
...
| `_docs/WIDGETS.md` | Update only if shared contract changes. |

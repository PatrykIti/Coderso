...
import type { ManifestableSmokeScenarioResult, SmokeEvidenceScreenshotV1 } from "../../_docs/_workflows/lib/smoke-evidence.mjs";
...
export function normalizeStrictManifestableScenario(value: unknown): ManifestableSmokeScenarioResult {
